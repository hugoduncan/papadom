...
(def ^:private mustache-node-regex #"<div class=\"t-mustache\">(.*?)</div>")
...
(defn process-template
  ...
  (let [template (string/replace (html el) mustache-node-regex "$1")]
